...
namespace WeChat.DataAccess.WeiXin
{
    public class WeiXinPublicAccount : WeiXinAccount
    {
        ...
        int WeChatPublicAccount_OnAccessTokenExpired(WeiXinAccount currentAccount)
        {
            try
            {
            ...
            {
                Log.ILog4_Error.Error("获取accessToken、jsapi_ticket出错：",ex);
        ...
        public static bool TryGetToken(string AppId, string Serce)
        {
            try
            {
                ...
                var returnValue = HttpClientHelper.Get<AccessTokenResponse>(initCommand);
                int outExpired = -1;
        ...
        private AccessTokenResponse GetAccessToken(string AppId, string Secret)
        {
            ...
            return HttpClientHelper.Get<AccessTokenResponse>(initCommand);
        }

        private JsTicketResponse GetJsTicket()
        {
            string initCommand = string.Format(URL_JS_API, this.AccessToken);
            return HttpClientHelper.Get<JsTicketResponse>(initCommand);
        }
        ...
        public CreateGroupResponse Groups_Create(string name)
        {
            ...
            return HttpClientHelper.Post<CreateGroupResponse, object>(initCommand, new { group = new { name = name } });
        }

        public GetGroupResponse Groups_Get()
        {
            string initCommand = string.Format(URL_TPL_GROUPSGET, this.AccessToken);
            return HttpClientHelper.Get<GetGroupResponse>(initCommand);
        }
        ...
        public GetGroupIdResponse Groups_GetId(string openId)
        {
            ...
            return HttpClientHelper.Post<GetGroupIdResponse, object>(initCommand, new { openid = openId });
        }
        ...
        public GeneralResponse Groups_Update(int id, string name)
        {
            ...
            return HttpClientHelper.Post<GeneralResponse, object>(initCommand, new { group = new { id = id, name = name } });
        }
        ...
        public GeneralResponse Groups_MembersUpdate(string openId, int toGroupId)
        {
            ...
            return HttpClientHelper.Post<GeneralResponse, object>(initCommand, new { openid = openId, to_groupid = toGroupId });
        }
        ...
        public GeneralResponse Groups_MembersBatchUpdate(string[] openIdList, int toGroupId)
        {
            ...
            return HttpClientHelper.Post<GeneralResponse, object>(initCommand, new { openid_list = openIdList, to_groupid = toGroupId });
        }

        public GeneralResponse Groups_Delete(int groupId)
        {
            string initCommand = string.Format(URL_TPL_GROUPSDELETE, this.AccessToken);
            return HttpClientHelper.Post<GeneralResponse, object>(initCommand, new { group = new { id = groupId } });
        }
        ...
        public GeneralResponse Menu_Create(string menuJsonString)
        {
            ...
            return HttpClientHelper.Post<GeneralResponse>(initCommand, menuJsonString);
        }

        public GeneralResponse Menu_Delete()
        {
            string initCommand = string.Format(URL_TPL_MENUDELETE, this.AccessToken);
            return HttpClientHelper.Get<GeneralResponse>(initCommand);
        }
        ...
        public MenuConditionalResponse Menu_AddConditional(string menuJsonString)
        {
            ...
            return HttpClientHelper.Post<MenuConditionalResponse>(initCommand, menuJsonString);
        }
        ...
        public MenuConditionalResponse Menu_DelConditional()
        {
            ...
            return HttpClientHelper.Post<MenuConditionalResponse>(initCommand, null);
        }
        ...
        public string Menu_TryMatch(string openIdOrWeixinId)
        {
            ...
            return HttpClientHelper.Post<string, object>(initCommand, new { user_id = openIdOrWeixinId });
        }
        ...
        public SendMessageTemplateResponse Message_TemplateSend(SendMessageTemplateRequest templateRequest)
        {
            ...
            return HttpClientHelper.Post<SendMessageTemplateResponse, SendMessageTemplateRequest>(initCommand, templateRequest);
        }
        public UserResponse User_Info(string openId, string lan = "zh-CN")
        {
            ...
            return HttpClientHelper.Get<UserResponse>(initCommand);
        }
